...
for i in arange(0, 101, 10):
    for j in arange(0, 21, 1):
        for k in arange(0, 101, 10):
            key = i,j,k
            array_of_sol = cubic_solver(i,j,k)
            R_array_of_sol = real_array_sol(array_of_sol)
            sol2.update({key : R_array_of_sol[0] })
...
for i in arange(0, 101, 10):
    for j in arange(0, 21, 1):
        for k in arange(0, 101, 10):
            ...
            array_of_sol = cubic_solver(i,j,k)
            R_array_of_sol = real_array_sol(array_of_sol)
            sol3.update({key : R_array_of_sol[0] })
